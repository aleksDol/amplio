...
def get_bundle_niche_choice_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="Изменить", callback_data="bundle:create:niche:change")],
...
def get_bundle_post_lifetime_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="24 часа", callback_data="bundle:create:lifetime:24")],
            [InlineKeyboardButton(text="48 часов", callback_data="bundle:create:lifetime:48")],
            [InlineKeyboardButton(text="72 часа", callback_data="bundle:create:lifetime:72")],
            [InlineKeyboardButton(text="Отмена", callback_data="bundle:create:cancel")],
        ]
    )
